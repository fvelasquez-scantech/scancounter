Public Class Configuration
    Public Shared Server As String = "192.168.3.3"
    ...
    Public Shared ConnectionString As String = $"Server={Server}\SQLEXPRESS;Database=Scancounter;User={User};Password=Scan2023##;"
